...
class RedactorWidget(widgets.Textarea):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        html = super(RedactorWidget, self).render(name, value, attrs, renderer=renderer)
