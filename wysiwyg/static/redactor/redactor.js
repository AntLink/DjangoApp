...
(function ($) {
    ...
    Redactor.fn = $.Redactor.prototype = {
        ...
        build: function () {
            return {
                ...
                setEvents: function () {
                    ...
                    $(document).on('mousedown.redactor.' + this.uuid, $.proxy(function (e) {
                        this.blurClickedElement = e.target;
                    }, this));
        ...
        image: function () {
            return {
                show: function () {
                    this.modal.load('image', this.lang.get('image'), 1000);
                ...
                loadTemplates: function () {
                    this.opts.modal = {
                        imageEdit: String()
                            ...
                            + '<input type="text" id="redactor-image-link" class="form-control redactor-image-link-option" aria-label="' + this.lang.get('link') + '" />'
                            + '<label class="redactor-image-link-option"><input type="checkbox" id="redactor-image-link-blank" aria-label="' + this.lang.get('link_new_tab') + '"> ' + this.lang.get('link_new_tab') + '</label>'
                            + '<label class="redactor-image-position-option">' + this.lang.get('image_position') + '</label>'
                            + '<select class="selectpicker redactor-image-position-option" id="redactor-image-align" aria-label="' + this.lang.get('image_position') + '">'
