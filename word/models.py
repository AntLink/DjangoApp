...
class Taxonomy(MPTTModel):
    ...
    parent = TreeForeignKey('self', verbose_name=_('Parent'), null=True, blank=True, db_index=True,on_delete=models.CASCADE)
...
class Word(models.Model):
    user = models.ForeignKey(User, verbose_name=_('Author'), blank=True, null=True,on_delete=models.CASCADE)
