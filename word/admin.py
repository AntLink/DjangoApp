...
from nifty.modeladmin import Admin, AdminCreate
        ...
        if request.method == 'POST':
            ...
            if all_valid(formsets) and form_validated:
                ...
                if add:
                    ...
                    change_message = self.construct_change_message(request, form, formsets, add=False)
...
# nifty_site.register(Word, PostAdmin)
# nifty_site.register(Taxonomy, CategoryAdmin)
# nifty_site.register(Taxonomy, TagAdmin)

AdminCreate(PostAdmin, Word, 'Post', _('Post'), _('Posts'))
AdminCreate(CategoryAdmin, Taxonomy, 'Category', _('Category'), _('Categories'))
AdminCreate(TagAdmin, Taxonomy, 'Tag', _('Tag'), _('Tags'))
