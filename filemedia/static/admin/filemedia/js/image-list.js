...
function createPreview(file) {
    ...
    previewElement.innerHTML =
        ...
        '<li><a target="_blank" class="btn-link" href="javascript:;"><i class="demo-pli-download-from-cloud"></i> Download</a></li>' +
        '</ul>' +
        '</div>' +
    ...
    // Add preview button to file details
    // var fileDetails = previewElement.querySelector('.file-details');
    // if (fileDetails) {
    //     var previewBtn = document.createElement('button');
    //     previewBtn.className = 'btn btn-sm btn-light preview-btn ms-2';
    //     previewBtn.title = 'Preview';
    //     previewBtn.innerHTML = '<i class="demo-psi-layout-grid"></i>';
    //     fileDetails.appendChild(previewBtn);
    //
    ...
    existingItems.forEach(function(item, index) {
        ...
        if (!item.querySelector('.preview-btn')) {
            ...
            if (fileDetails) {
                ...
                // Tambahkan tombol ke file details
                fileDetails.appendChild(previewBtn);
                ...
                previewBtn.addEventListener('click', function(e) {
                    ...
                    if (downloadLink && downloadLink.href) {
                        ...
                        showImagePreview(downloadLink.href, downloadLink.textContent, imageIndex);
                    }
                });
            }
        }
