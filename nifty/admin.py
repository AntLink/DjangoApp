...
from .widgets import NumberInput, NiftySplitDateTimeWidget
from django.contrib.contenttypes import admin as ct_admin
from .models import Site, Admin as AdminSetting
from .models import LogEntrys
from .settings import SiteSettingAdmin, AdminSettingAdmin
...
nifty_site.register(LogEntrys, LogEntryAdmin)
nifty_site.register(Site, SiteSettingAdmin)
nifty_site.register(AdminSetting, AdminSettingAdmin)
...
if 'cms' in settings.INSTALLED_APPS:
    try:
        ...
        PageForm.Meta.widgets = {
            'publication_date': NiftySplitDateTimeWidget,
            'publication_end_date': NiftySplitDateTimeWidget,
        }
    except ImportError:
        pass
