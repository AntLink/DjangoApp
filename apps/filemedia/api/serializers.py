...
class CategorySerializer(serializers.ModelSerializer):
    ...
    # def get_extensions(self, obj):
    #     """
    #     Konversi string JSON ke array dengan penanganan error yang lebih baik
    #     """
    #     if not obj.extensions:
    #         return []
    #
    #     # Jika sudah berupa list (misal karena JSONField), langsung return
    #     if isinstance(obj.extensions, list):
    #         return obj.extensions
    #
    #     # Jika string, coba parse sebagai JSON
    #     try:
    #         parsed = json.loads(obj.extensions)
    #         # Pastikan hasil parsing adalah list
    #         if isinstance(parsed, list):
    #             return parsed
    #         # Jika bukan list, bungkus dalam array
...
class MediaSearchPayloadSerializer(serializers.Serializer):
