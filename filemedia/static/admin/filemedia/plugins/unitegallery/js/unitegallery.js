...
function UGTileDesign(){
	...
	function setHtmlThumb(objThumbWrapper, objItem){
		...
		if(g_temp.hasImageContainer == true){
		 ...
		 if(g_options.tile_show_chekbox_label == true){
			    html += '<label class="form-checkbox form-normal form-primary" style="z-index: 3; position: absolute; margin-left: 5px;margin-top: 10px"><input type="checkbox" name="_selected_action" value="'+objItem.checkbox_value +'" class="action-select"></label>'
            }
...
function __________INIT_GALLERY_______() {
	...
	function fillItemByChild(objChild){
		...
		var isMobile = t.isMobileMode();
		 ...
		 var checkbox_value = '';
		 if(tagname == "label"){
		     var objChildl = objChild.children();
		     checkbox_value = objChildl.val();
			 var tagnames = objChildl.prop("tagName").toLowerCase();
		 ...
		 objItem.checkbox_value = checkbox_value;
